        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 pb-20 pt-10">
            <div className="flex flex-col md:flex-row items-start justify-between mb-12 gap-6">
                <div className="text-left">
                    <div className="flex items-center gap-2 text-orange-500 font-black uppercase tracking-widest text-sm mb-2">
                        <TrendingUp className="w-5 h-5" />
                        <span>Os Favoritos</span>
                    </div>
                    <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight">Mais Vendidos</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-2 font-medium">Os produtos mais populares e desejados pelos nossos clientes.</p>
                </div>
                <button
                    onClick={() => navigate('/')}
            ...
            {isLoading ? (
                ...
                <div className="py-20 text-center bg-white dark:bg-gray-800 rounded-4xl border-2 border-dashed border-gray-100 dark:border-gray-700">
                    <p className="text-gray-500 font-bold">Ainda não temos dados sobre os mais vendidos.</p>
                </div>
            )}
        </div>
    );
